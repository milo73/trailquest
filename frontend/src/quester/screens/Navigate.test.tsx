...
const trail: Trail = {
  ...
  stops: [
    { order: 1, story: "s", questions: [{ type: "C", prompt: "?", gates: false }], primary_question_index: 0, poi: { id: "p1", name: "Grote Markt", location: { lat: 52.38, lon: 4.63 }, facts: [] } },
    { order: 2, story: "s", questions: [{ type: "A", prompt: "?", answer: "78", gates: true }], primary_question_index: 0, poi: { id: "p2", name: "Sint-Bavokerk", location: { lat: 52.38, lon: 4.63 }, facts: [] } },
  ],
};
